...
def create_provider(provider_name: str | None = None) -> AIProvider:
    ...
    providers = {
        'premium_claude': ('.antigravity_provider', 'AntigravityProvider'),
        'groq': ('.groq_provider', 'GroqProvider'),
        'groq_llama': ('.groq_provider', 'GroqProvider'),
        'groq_scout': ('.groq_provider', 'GroqProvider'),
        ...
        'kimi_k3': ('.openrouter_provider', 'OpenRouterProvider'),
        'hermes_405b': ('.openrouter_provider', 'OpenRouterProvider'),
        'owl_alpha': ('.openrouter_provider', 'OpenRouterProvider'),
        'glm_52': ('.openrouter_provider', 'OpenRouterProvider'),
        'minimax_m3': ('.openrouter_provider', 'OpenRouterProvider'),
        'qwen38_max_preview': ('.openrouter_provider', 'OpenRouterProvider'),
        'deepseek_v4_flash': ('.openrouter_provider', 'OpenRouterProvider'),
        'llama_4_scout': ('.openrouter_provider', 'OpenRouterProvider'),
        'glm_5_turbo': ('.openrouter_provider', 'OpenRouterProvider'),
        'longcat_2': ('.openrouter_provider', 'OpenRouterProvider'),
        'local': ('.local_provider', 'LocalProvider'),
        'local_qwen3_4b': ('.local_provider', 'LocalProvider'),
        'local_qwen_3b': ('.local_provider', 'LocalProvider'),
